...
package datasource_interface_module_list
...
func InterfaceModuleListDataSourceSchema(ctx context.Context) schema.Schema {
...
type InterfaceModuleListModel struct {
