...
package datasource_control_module
...
func ControlModuleDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the ControlModule",
			},
			"namespace": schema.StringAttribute{
				Required:            true,
			...
			"status": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"role": schema.StringAttribute{
						...
						MarkdownDescription: "Role of the control module",
					},
				...
				MarkdownDescription: "ControlModuleStatus defines the observed state of ControlModule",
			},
		},
	}
}

type ControlModuleModel struct {
