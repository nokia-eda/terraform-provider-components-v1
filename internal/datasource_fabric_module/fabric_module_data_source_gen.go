...
package datasource_fabric_module
...
func FabricModuleDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the FabricModule",
			},
			"namespace": schema.StringAttribute{
				Required:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "FabricModuleStatus defines the observed state of FabricModule",
			},
		},
	}
}

type FabricModuleModel struct {
