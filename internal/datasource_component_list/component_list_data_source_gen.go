...
package datasource_component_list
...
func ComponentListDataSourceSchema(ctx context.Context) schema.Schema {
						...
						"status": schema.SingleNestedAttribute{
							Attributes: map[string]schema.Attribute{
								"enabled": schema.BoolAttribute{
									...
									MarkdownDescription: "The administrative status of this Component.",
								},
								...
								"type": schema.StringAttribute{
									...
									MarkdownDescription: "Component type, as provided by the node.",
								},
							},
							...
							MarkdownDescription: "ComponentStatus defines the observed state of Component",
						},
					},
