...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-components/internal/eda/utils"
...
var _ provider.Provider = (*componentsProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &componentsProvider{version: ver}
	}
}
...
func (p *componentsProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *componentsProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *componentsProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "components-v1"
	resp.Version = p.version
}

func (p *componentsProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewChassisDataSource,
		NewChassisListDataSource,
		NewComponentDataSource,
		NewComponentListDataSource,
		NewControlModuleDataSource,
		NewControlModuleListDataSource,
		NewFabricModuleDataSource,
		NewFabricModuleListDataSource,
		NewFanDataSource,
		NewFanListDataSource,
		NewInterfaceModuleDataSource,
		NewInterfaceModuleListDataSource,
