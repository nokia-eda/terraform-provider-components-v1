...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-components/internal/datasource_component"
...
const read_ds_component = "/apps/components.eda.nokia.com/v1/namespaces/{namespace}/components/{name}"
...
func (d *componentDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_component, map[string]string{
...
func (r *componentDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
