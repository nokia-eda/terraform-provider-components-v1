...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-components/internal/datasource_monitor"
...
const read_ds_monitor = "/apps/components.eda.nokia.com/v1/namespaces/{namespace}/monitors/{name}"
