...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-components/internal/datasource_chassis"
...
const read_ds_chassis = "/apps/components.eda.nokia.com/v1/namespaces/{namespace}/chassis/{name}"

var (
	_ datasource.DataSource              = (*chassisDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*chassisDataSource)(nil)
)
...
func (d *chassisDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *chassisDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_chassis, map[string]string{
...
func (r *chassisDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
