...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-components/internal/resource_monitor"
	"github.com/nokia/eda/apps/terraform-provider-components/internal/tfutils"
)

const (
	create_rs_monitor = "/apps/components.eda.nokia.com/v1/namespaces/{namespace}/monitors"
	read_rs_monitor   = "/apps/components.eda.nokia.com/v1/namespaces/{namespace}/monitors/{name}"
	update_rs_monitor = "/apps/components.eda.nokia.com/v1/namespaces/{namespace}/monitors/{name}"
	delete_rs_monitor = "/apps/components.eda.nokia.com/v1/namespaces/{namespace}/monitors/{name}"
)
