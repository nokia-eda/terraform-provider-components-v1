...
package datasource_power_supply
...
func PowerSupplyDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the PowerSupply",
			},
			"namespace": schema.StringAttribute{
				Required:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"foo": schema.StringAttribute{
						...
						MarkdownDescription: "INSERT ADDITIONAL SPEC FIELDS - define desired state of cluster\nImportant: Run \"edabuilder generate\" to regenerate code after modifying this file",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	fooAttribute, ok := attributes["foo"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`foo is missing from object`)

		return nil, diags
	}

	fooVal, ok := fooAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`foo expected to be basetypes.StringValue, was: %T`, fooAttribute))
	}
...
type SpecValue struct {
	Foo   basetypes.StringValue `tfsdk:"foo"`
	state attr.ValueState
}
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["foo"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.Foo.ToTerraformValue(ctx)
